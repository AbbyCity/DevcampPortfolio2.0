class BlogsController < ApplicationController
  ...
  def show
    if logged_in?(:site_admin) || @blog.published?
      ...
      redirect_to blogs_path, notice: 'Sorry, you are not authorized to access that page'
    end
  end
  ...
  def update
    respond_to do |format|
      if @blog.update(blog_params)
        format.html { redirect_to @blog, notice: 'Everything is now up to date' }
      else
  ...
  def toggle_status
    ...
    redirect_to blogs_url, notice: 'Updated.'
  end
